...
- 2026-05-25: `./mvnw -Dtest=PronunciationAudioGeneratorTest,PronunciationGenerationProcessorTest,PronunciationServiceTest test` passed after simplifying `PronunciationAudioGenerator` to one constructor and no injected function field; 10 focused tests passed.
